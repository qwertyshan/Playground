...
let yourSentence = "The \(nounArray[0]) spilled her \(nounArray[3])."
...
let numChar = howManyCharacters.characters.count
...
//desired output = "$5.67"
var pennies = numOfPennies % 100
var dollars = (numOfPennies - pennies)/100
var money = "$"+String(dollars)+"."+String(pennies)
//: # Let or Var?
import UIKit
import Foundation
//: ### Exercise 9
